...
영화 제목 검색만으로 포스터와 개봉 일자를 제공하고, 원하는 영화 포스터를 선택하면 영화 정보를 얻을 수 있습니다.
선택적으로 AI를 활용한 한 줄 요약을 한 화면에서 제공합니다.
...
2. 영화 제목 입력 후 검색
3. 영화 포스터 확인
4. 정보를 얻고자 하는 영화 포스터 선택 -> 정보 획득
5. (선택) 필요 시 AI 요약 버튼 -> AI 한 줄 요약 획득
